...
`polaroid-img` displays images in a styled container with customizable background colors and effects.
...
- Desktop (>=650px): 300px × 300px outer container, 50px padding, 200px × 200px inner container
- Mobile (<650px): 200px × 200px outer container, 33px padding, 134px × 134px inner container
- Outer container always has 8px border-radius

```html
<!-- Basic usage with image -->
<polaroid-img img="assets/images/cow.avif"></polaroid-img>
```

```html
<!-- No background color -->
<polaroid-img img="assets/images/cow.avif" none></polaroid-img>
```

```html
<!-- Circular background -->
<polaroid-img img="assets/images/cow.avif" round="9999"></polaroid-img>
```

```html
<!-- Image offset -->
<polaroid-img img="assets/images/cow.avif" offset="30"></polaroid-img>
```

```html
<!-- Custom background color -->
<polaroid-img img="assets/images/cow.avif" color="CAEE64"></polaroid-img>
```

```html
<!-- Tint image with background color -->
<polaroid-img img="assets/images/cow.avif" tint></polaroid-img>
```
